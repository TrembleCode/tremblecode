...
function Sidebar() {
  return (
    <aside className="w-64 shrink-0 border-r border-tui-border bg-tui-panel flex flex-col font-mono">
      <div className="p-4 border-b border-tui-border">
        <div className="font-display text-3xl text-tui-active tracking-widest">
          TREMBLECODE
        </div>
      ...
      <nav className="flex-1 px-3 space-y-0.5 pb-4">
        <NavLink href="/" prefix="[01]">Projects</NavLink>
        <NavLink href="/inbox" prefix="[02]">Inbox</NavLink>
        <NavLink href="/settings" prefix="[03]">Settings</NavLink>
      </nav>
      ...
      <head>
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{var v=['dark','light','normal-dark','normal-light'];var t=localStorage.getItem('tui-theme');document.documentElement.setAttribute('data-theme',v.indexOf(t)>=0?t:'dark');}catch(e){}})();`,
          }}
        />
        <link rel="preconnect" href="https://fonts.googleapis.com" />
        <link rel="preconnect" href="https://fonts.gstatic.com" crossOrigin="anonymous" />
        <link
          href="https://fonts.googleapis.com/css2?family=VT323&family=Share+Tech+Mono&family=JetBrains+Mono:wght@400;500;600&family=Source+Serif+4:opsz,wght@8..60,400;8..60,600&display=swap"
          rel="stylesheet"
        />
      </head>
      <body>
